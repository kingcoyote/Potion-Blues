...
namespace PotionBlues.Definitions
{
    public class UpgradeCardDefinition : ScriptableObject
    {
        ...
        [BoxGroup("Base"), SerializeField, ValueDropdown("GetUpgradeCardTypes")] private UpgradeCardTypeDefinition _type;
        [BoxGroup("Base"), SerializeField, TextArea(3, 10)] private string _description;
        ...
        [BoxGroup("Base"), SerializeField] private int _reputationCost;
        [BoxGroup("Base"), SerializeField] private int _goldCost;
